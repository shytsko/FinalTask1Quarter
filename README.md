...
![Database diagramm](img\DB_diagram.png)
...
![Classes diagramm](img\classes_diagramm.png)

Реализация в проекте - классы в пакете Animals
...
Реализация в проекте - классы AnimalNursery и main. 
...
Реализация проекте - класс Counter
